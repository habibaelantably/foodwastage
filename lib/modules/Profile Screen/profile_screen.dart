              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    CircleAvatar(
                      radius: 40.0,
                      backgroundImage: NetworkImage(profileUserModel.image!),
                    ),
                    const SizedBox(
                      width: 30.0,
                    ),
              ...
              Expanded(
                child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return buildMyPosts(
                        context: context,
                        myPost: uId == selectedUserId
                            ? FoodCubit.get(context).currentUserPostsList[index]
                            : FoodCubit.get(context)
                    ...
                    itemCount: selectedUserId == uId
                        ...
                        : FoodCubit.get(context).selectedUserPostsList.length),
              )
            ],
          ),
        );
          ...
          Container(
            ...
            decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: NetworkImage(myPost.imageUrl1!),
                  fit: BoxFit.fill,
                )),
          ),
          const SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    CircleAvatar(
                      backgroundImage: NetworkImage(myPost.userImage!),
                    ),
                    const SizedBox(
                      width: 5.0,
                    ),
                ...
                selectedUserId != uId
                    ...
                    : Padding(
                        ...
                        child: PopupMenuButton<String>(
                            ...
                            onSelected: (value) {
                              if (value == "Delete") {
                                FoodCubit.get(context).deletePost(
                                    FoodCubit.get(context).myPostsId[index]);
                              }
                            },
